...
public class MessageAlert {
    ...
    public static void create(Context context, int messageType, String message) {
        View toastContent = ((Activity) context).getLayoutInflater().inflate(R.layout.layout_alerts_messagealert, ((Activity) context).findViewById(R.id.Toast_Main));
        Toast toast = new Toast(context);
        toast.setView(toastContent);
        switch (messageType) {
            case TYPE_ALERT:
                ((ImageView) toastContent.findViewById(R.id.Toast_Icon)).setImageResource(R.drawable.ic_alert);
                toastContent.findViewById(R.id.Toast_Main).setBackgroundTintList(ColorStateList.valueOf(context.getResources().getColor(android.R.color.holo_orange_dark)));
                break;
            case TYPE_ERRO:
                ((ImageView) toastContent.findViewById(R.id.Toast_Icon)).setImageResource(R.drawable.ic_erro);
                toastContent.findViewById(R.id.Toast_Main).setBackgroundTintList(ColorStateList.valueOf(context.getResources().getColor(android.R.color.holo_red_light)));
                break;
            default:
                ((ImageView) toastContent.findViewById(R.id.Toast_Icon)).setImageResource(R.drawable.ic_done);
                toastContent.findViewById(R.id.Toast_Main).setBackgroundTintList(ColorStateList.valueOf(context.getResources().getColor(android.R.color.holo_green_dark)));
                break;
        }
